...
> **Note:** This information is for repository Maintainers, Owners, and Admins. If you are a Contributor, then you will not be able to perform most of the tasks in this topic.

The core maintainers of the Common GitHub Actions are responsible for categorizing all incoming issues and delegating any critical or important issue to other maintainers. Triage provides an important way to contribute to an open source project.
...
Make sure that the issue's author provided the standard issue information. The Common GitHub Actions utilizes GitHub issue templates to guide contributors to provide standard information that must be included for each type of template or type of issue.
...
- The GitHub action the issue is related to
